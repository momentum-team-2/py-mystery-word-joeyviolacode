...
def handle_family_selection(list_of_words, letter_to_check):
    ...
    words_keyed = mystery_word.map_key_to_word(list_of_words, letter_to_check)
    ...
    print(words_keyed)
    print("_________________________________________________________________________")
    keys = mystery_word.collect_keys(words_keyed)
    print("\nThe next step is to collect a list of all the unique keys in the dictionary.\n")
    print(keys)
    print("_________________________________________________________________________")
    sorted_words = mystery_word.sort_by_key(words_keyed, keys)
    ...
    print(sorted_words)
    print("_________________________________________________________________________")
    family = mystery_word.select_family(sorted_words)
